...
<template>
    <div>
        <InputGroup>
            <InputText placeholder="" :value="modelValue" :disabled="modeReadonly" @input="emit('update:modelValue', $event.target.value)" />
            <Button icon="pi pi-map-marker" style="background-color: red" @click="visible = true" :disabled="modeReadonly" />
        </InputGroup>
        ...
        >
            <div style="height: 100%; width: 100%">
                <longdoMapPage :id="props.id" :locationsCode="locationsCode" :lat="lat" :lon="lon" @location-updated="alertUpdate" @location-Wanning="alertLocations"></longdoMapPage>
            </div>
        </Dialog>
    </div>
</template>
