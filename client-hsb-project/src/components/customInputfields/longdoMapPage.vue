...
export default {
    ...
    setup(props, { emit }) {
        ...
        const search = async (event) => {
            const res = await axios.get(`https://search.longdo.com/smartsearch/json/search?keyword=${event.query}&key=2dad446cee13a4155665e5000991ef93`);
        ...
        const addMarkerData = async () => {
            ...
            try {
                ...
                const res = await axios.get(`https://api.longdo.com/POIService/json/search?lon=${result.lon}&lat=${result.lat}&key=2dad446cee13a4155665e5000991ef93`);
        ...
        const fetchDataLocations = async () => {
            ...
            try {
                // Reverse geocoding to get location name and ID
                const res = await axios.get(`https://api.longdo.com/POIService/json/search?lon=${props.lon}&lat=${props.lat}&key=2dad446cee13a4155665e5000991ef93`);
    ...
    <div class="grid" style="padding-bottom: 10px; padding-top: 10px">
        <div class="col">
            <div class="bg-primary" style="width: 100%; padding: 0">
                <AutoComplete v-model="value" optionLabel="name" :suggestions="items" @complete="search" @item-select="searchSelected" inputStyle="width: 100%;" style="width: 100%">
        ...
        <div class="col-1">
            <div class="font-bold">
                <Button type="button" label="เพิ่มหมุด" @click="addMarkerData" style="background-color: red; border-color: red" />
